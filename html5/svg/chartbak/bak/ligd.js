...
define(function(require, exports, module) {
    ...
    exports.init = function() {
        ...
        //初始化另一个漏斗图
        var funnelb=new Funnelb({
        	"element":"#chart-funnelb",
        	"info":{
	        	width:340,                //宽度(em)
	            toppadding:0,            //顶部边距(em)
	            bottompadding:0,         //底部边距(em)
	            rightpadding:180,         //右部边距(em)
	            title:"Sales funnel",
	            series:{
	                name:'Unique users',
	                data:[
        ...
        funnelb.activeStage(4);

        //销售阶段
        var stage=new chart.Salesstage('#chart-test',4);
        //必须设置延迟啊 要等数据传过来才能初始化图表 并changeStage
        setTimeout(function(){stage.changeStage(3)},200);
    ...
    var popup=poppaper.popup(200,100,"hello world","left-top");
        ...
        popup.ltranslate(400,0,"Hello World","right-bottom");
    };
});   
